...
export default function LiveAppSection({ sectionRef }) {
  ...
  return (
    <section className="live-app-section" ref={sectionRef} id="try-live-demo">
      <div className="section-container" style={{ maxWidth: '1400px' }}>
        ...
        <p className="section-subheading" style={{ marginBottom: 'var(--space-12)' }}>
          Paste your own Python or JavaScript code below and watch the AST-grounded pipeline in action.
        </p>
        
        <div className="app" style={{ height: '700px', position: 'relative', border: '1px solid var(--ink-surface-raised)', borderRadius: 'var(--radius-lg)', overflow: 'hidden' }}>
          {/* Mobile overlay */}
          {sidebarOpen && (
          ...
          <main className="app-main">
            ...
            <header className="header">
              <div className="header-brand">
                ...
                <div>
                  <div className="header-title">Live Explainer</div>
                </div>
              </div>
            </header>
